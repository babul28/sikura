    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <!--level one-->
          <ul class="treeview-menu">
            <li><a href=<?php echo "index.php?user=".$_SESSION['level_user']."&page=data-penghulu"; ?>><i class="fa fa-file-text"></i>Data Penghulu</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-maroon-active">
              ...
              <h5 class="widget-user-desc">Pegawai KUA</h5>
            </div>
        ...
        <div class="col-md-2 col-xs-6">
          ...
          <div class="small-box bg-teal">
            <div class="inner">
              <h3><?php $total = $jnikah+$jcerai+$jrujuk; echo $total ?></h3>
