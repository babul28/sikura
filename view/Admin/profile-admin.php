    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active menu-open">
          ...
          <!--level one-->
          <ul class="treeview-menu">
            <li class="active"><a href=<?php echo "index.php?user=".$_SESSION['level_user']."&page=profile"; ?>><i class="fa fa-user"></i>Profile Admin</a></li>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-user"></i> Profile Admin</a></li>
      </ol>
  </section>
      ...
      <div class="col-md-4">
        <div class="box box-success">
          <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src=<?php echo $_SESSION['foto']; ?> alt="User profile picture">
              <h3 class="profile-username text-center"><?php echo $_SESSION['nama'] ?></h3>
              <p class="text-muted text-center">Administrator</p>
              <?php
                foreach ($pegawai->getDataById($_SESSION['id_user']) as $key) {
                  $data = $key;
                }
              ?>
              ...
              if(isset($_POST['edit'])){
                ...
                if($query != ''){?>
                  <script>
                    ...
                    window.location="<?php echo "index.php?user=admin&page=profile&edit+data+user=success"?>";
                  </script>
                  <?php
                }else{?>
                  <script>
                    alert("<?php echo 'Edit data user dengan nama '.$nama_user.' Gagal' ?>");
                    window.location="<?php echo "index.php?user=admin&page=profile&edit+data+user=failed"?>";
                  </script>
                <?php
                }
              }
