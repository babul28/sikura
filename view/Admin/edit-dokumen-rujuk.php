      ...
      <div class="modal-body form-horizontal">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class='form-control' name="id_rujuk" value=<?php echo $id;?> disabled>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="tanggal" class="col-sm-4 control-label">Tanggal Rujuk</label>
                      <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      <label for="tempat" class="col-sm-4 control-label">Tempat Ijab Qobul</label>
                      <div class="col-sm-6">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-success pull-left" data-dismiss="modal"><a href="index.php?user=admin&page=dokumen-rujuk" style="color: white;">Back</a></button>
                <button type="submit" name="update" class="btn btn-success">Update</button>
              </div>
            </form>
            <?php
              if(isset($_POST['update'])){
                $tanggal_rujuk = $_POST['tanggal'];
                $tempat_rujuk  = $_POST['tempat'];
                $id_penghulu        = $_POST['penghulu'];

                $query = mysqli_query($config->koneksi(), "UPDATE data_rujuk SET tempat_rujuk = '$tempat_rujuk', tanggal_rujuk = '$tanggal_rujuk', penghulu = '$id_penghulu' WHERE id_rujuk = $id");

                if($query != ''){?>
                  <script>
                    alert("<?php echo 'Dokumen Rujuk dengan Id Pendaftaran '.$id.' Sukses di edit' ?>");
                    window.location="<?php echo "index.php?user=admin&page=dokumen-rujuk&id_rujuk=".$id."&edit+dokumen+rujuk=success"?>";
                  </script>
                  <?php
                }else{?>
                  <script>
                    alert("<?php echo 'Dokumen Rujuk dengan Id Pendaftaran '.$id.' Gagal di edit' ?>");
                    window.location="<?php echo "index.php?user=admin&page=dokumen-rujuk&id_rujuk=".$id."&edit+dokumen+rujuk=failed"?>";
                  </script>
                <?php
                }
              }
