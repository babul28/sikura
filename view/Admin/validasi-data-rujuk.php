        ...
        <li class="treeview active menu-open">
          ...
          <ul class="treeview-menu">
            <li class="treeview">
              ...
              <li class="active"><a href=<?php echo "index.php?user=".$_SESSION['level_user']."&page=validasi-data-rujuk"; ?>><i class="fa fa-check-square-o"></i>Validasi Data</a></li>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Rujuk Pernikahan
        <small>Verifikasi Data</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-check-square-o"></i> Data Rujuk Pernikahan</a></li>
  ...
  <section class="content">
                ...
                <div class="form-group">
                    ...
                    <?php
                      if(isset($_POST['verifikasi'])){
                        ...
                        $query = mysqli_query($config->koneksi(), "UPDATE rujuk SET verifikasi = 'true' WHERE id_rujuk = $validasi");

                        if($query != ''){
                          ?>
                          <script>
                            alert("<?php echo 'Validasi Pendaftaran ID_rujuk '.$validasi.' Sukses' ?>");
                            window.location="<?php echo "index.php?user=admin&page=validasi-data-rujuk&id_rujuk=".$validasi."&verifikasi=success"?>";
                          </script>
                          <?php
                        }else{?>
                          <script>
                            alert("<?php echo 'Validasi Pendaftaran ID_rujuk '.$validasi.' Gagal' ?>");
                            window.location="<?php echo "index.php?user=admin&page=validasi-data-rujuk&id_rujuk=".$validasi."&verifikasi=Failed"?>";
                          </script>
                        <?php
                        }
                      } ?>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Data Laki - Laki</h3>
               </div>
            <!-- /.box-header -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Data Perempuan</h3>
