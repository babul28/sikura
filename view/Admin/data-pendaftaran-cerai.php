    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active menu-open">
          ...
          <ul class="treeview-menu">
            <li class="treeview active menu-open">
              <li class="active"><a href=<?php echo "index.php?user=".$_SESSION['level_user']."&page=data-pendaftaran-cerai"; ?>><i class="fa fa-file-text"></i>Data Pendaftaran</a></li>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Perceraian
        <small>Data Pendaftaran Perceraian</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-heartbeat"></i> Perceraian</a></li>
        <li class="active">Data Cerai</li>
      </ol>
  </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Calon Penggugat Cerai</h3>
