          ...
          <ul class="treeview-menu">
            <li class="treeview active menu-open">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href=<?php echo "index.php?user=".$_SESSION['level_user']."&page=data-capin-wanita"; ?>><i class="fa fa-female"></i>Data Capin Wanita</a></li>
              </ul>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-female"></i> Pernikahan</a></li>
        <li class="active">Data Pendaftaran</li>
        <li class="active">Data Capin Perempuan</li>
      </ol>
  </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Calon Pengantin Perempuan</h3>
